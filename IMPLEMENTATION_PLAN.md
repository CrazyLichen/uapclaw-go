...
| 5.6 | ✅ | SessionController | 会话控制器；✅ 已实现 Scope/Subject 体系、DataContainer 工厂、ChainSession、SessionController、GlobalSessionController、回调集成；⤵️ P2P/PubSub 回调待 5.13+ 回填 | `openjiuwen/core/session/session_controller/` |
