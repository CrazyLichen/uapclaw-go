...
| 10.3.7-11 | 🔄 | 适配器辅助 | CodeAgentRail✅/TeamHelpers☐(⤵️9.55-9.65)/EvolutionHelpers✅/RecapPrompts✅/SysOpBuilder✅(一比一对齐Python:BuildFilesystemPolicy+CreateSandboxSysOpCard+CreateLocalSysOpCard+展示辅助+实例化注册)/handleCommandRecap✅+Compact✅+Context✅连接adapter/DeepAdapter.CreateInstance步骤17✅；✅ 回填审查修复：⤵️标记修正3处(10.3.7-11→9.55-9.65/10.6.3-10)/modelCache类型断言获取/CodeAgentRail热重载/ListAvailableTools动态构建 | `jiuwenswarm/server/runtime/agent_adapter/` |
