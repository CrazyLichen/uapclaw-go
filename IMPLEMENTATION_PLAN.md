...
| 5.7 | ✅ | Interaction | ✅ BaseInteraction/WorkflowInteraction/SimpleAgentInteraction/AgentInteraction/InteractiveInput/InteractionOutput/GraphInterrupt/Interrupt/AgentInterrupt 已实现；✅ 已回填 5.5 NodeSessionFacade.Interact()；✅ 已回填 5.9 Session.Interact() | `openjiuwen/core/session/interaction/` |
