...
- [ ] **Step 1: FormatWithSchemaMap 改用 jsonschema 库校验**
...
- [ ] **Step 3: validateParamConstraints 增加 MinItems/MaxItems 校验**
...
- [ ] **Step 4: FormatWithSchema 增加递归默认值填充**
