...
// Python 执行步骤：
//
//  1. builder = SystemPromptBuilder(language="en")
//  2. for generator in _CODE_SECTION_GENERATORS: builder.add_section(generator())
//  3. return builder.build()
func BuildCodeSystemPrompt() string {
	// 步骤 1: 对齐 Python: builder = SystemPromptBuilder(language="en")
...
func BuildCodeIntroSection() saprompt.PromptSection {
	...
	return saprompt.PromptSection{
		...
		Priority: int(CodePriorityIntro),
	}
}
...
func BuildCodeSystemSection() saprompt.PromptSection {
	...
	return saprompt.PromptSection{
		Name:     "code_system",
		Content:  map[string]string{"en": content},
		Priority: int(CodePrioritySystem),
	}
}
...
func BuildCodeDoingTasksSection() saprompt.PromptSection {
	...
	return saprompt.PromptSection{
		...
		Content:  map[string]string{"en": content},
		Priority: int(CodePriorityDoingTasks),
	}
}
...
func BuildCodeUsingYourToolsSection() saprompt.PromptSection {
	...
	return saprompt.PromptSection{
		...
		Content:  map[string]string{"en": content},
		Priority: int(CodePriorityUsingTools),
	}
}
...
func BuildCodeActionsWithCareSection() saprompt.PromptSection {
	...
	return saprompt.PromptSection{
		...
		Content:  map[string]string{"en": content},
		Priority: int(CodePriorityActionsWithCare),
	}
}
...
func BuildCodeToneAndStyleSection() saprompt.PromptSection {
	...
	return saprompt.PromptSection{
		...
		Content:  map[string]string{"en": content},
		Priority: int(CodePriorityToneAndStyle),
	}
}
...
func BuildCodeOutputEfficiencySection() saprompt.PromptSection {
	...
	return saprompt.PromptSection{
		...
		Content:  map[string]string{"en": content},
		Priority: int(CodePriorityOutputEfficiency),
	}
}
...
func BuildCodeSessionGuidanceSection() saprompt.PromptSection {
	...
	content := "# Session-specific guidance\n" +
		...
		"- Use the task_tool with specialized agents when the task at hand " +
