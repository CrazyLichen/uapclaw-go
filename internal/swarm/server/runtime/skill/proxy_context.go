...
// Python: _skillnet_network_context (skill_manager.py L49-58, L172-193)
//
...
func skillnetNetworkContext() func() {
	...
	// Python: if not os.environ.get("NO_PROXY") and not os.environ.get("no_proxy"):
