...
// Python: _register_mcp_servers_from_config(config_base, tag) (line 1169-1213)
//
...
// Python: _sync_mcp_servers_for_runtime(config_base, tag) (line 1214-1273)
//
...
// Python: _build_mcp_server_config() (line 972-1020)
...
// Python: _extract_enabled_mcp_server_entries() (line 1021-1060)
...
func (d *DeepAdapter) extractEnabledMcpServerEntries(configBase map[string]any) []map[string]any {
	// Python: mcp_cfg = config_base.get("mcp", {})
	mcpCfg, _ := configBase["mcp"].(map[string]any)
	if mcpCfg == nil {
		return nil
	}

	// Python: servers = mcp_cfg.get("servers", [])
...
// Python: _register_mcp_server() (line 1061-1100)
...
// Python: _unregister_mcp_server() (line 1101-1130)
