...
// Python: get_chat_id 中的 feishu/wecom/dingtalk/xiaoyi 优先级
...
// Python: is_team_params 中的 {"team", "team.plan", "code.team"}
...
// Python: get_chat_id(request) (utils.py L5-24)
...
// Python: is_team_params(params) (utils.py L26-42)
