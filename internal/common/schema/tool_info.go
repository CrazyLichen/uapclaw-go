...
// 不关心具体是本地工具还是 MCP 工具。
//
// Python: _convert_tools_to_dict() 中统一处理 ToolInfo / McpToolInfo 的逻辑
...
//
// Python: openjiuwen/core/foundation/tool/schema.py (ToolInfo)
...
//
// Python: openjiuwen/core/foundation/tool/schema.py (McpToolInfo)
