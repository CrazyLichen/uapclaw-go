...
func TestRunAgent_正常调用(t *testing.T) {
	ag := &mockAgent{
		card:   agentschema.NewAgentCard(agentschema.WithAgentName("test-agent"), agentschema.WithAgentDescription("测试 Agent")),
...
func TestRunAgent_执行错误(t *testing.T) {
	ag := &mockAgent{
		card: agentschema.NewAgentCard(agentschema.WithAgentName("err-agent"), agentschema.WithAgentDescription("错误 Agent")),
...
func TestRunAgent_无会话(t *testing.T) {
	ag := &mockAgent{
		card:   agentschema.NewAgentCard(agentschema.WithAgentName("no-sess-agent"), agentschema.WithAgentDescription("无会话 Agent")),
...
func TestRunAgentStreaming_正常调用(t *testing.T) {
	...
	ag := &mockAgent{
		card:     agentschema.NewAgentCard(agentschema.WithAgentName("stream-agent"), agentschema.WithAgentDescription("流式 Agent")),
		streamCh: ch,
	}
...
func TestRunAgentStreaming_无会话(t *testing.T) {
	...
	ag := &mockAgent{
		card:     agentschema.NewAgentCard(agentschema.WithAgentName("stream-no-sess"), agentschema.WithAgentDescription("流式无会话 Agent")),
		streamCh: ch,
	}
...
func TestRunAgentStreaming_流式错误(t *testing.T) {
	ag := &mockAgent{
		card:      agentschema.NewAgentCard(agentschema.WithAgentName("stream-err"), agentschema.WithAgentDescription("流式错误 Agent")),
...
func TestIsRemoteAgent(t *testing.T) {
	ag := &mockAgent{
		card: agentschema.NewAgentCard(agentschema.WithAgentName("remote-check"), agentschema.WithAgentDescription("远程判断")),
	}
	if IsRemoteAgent(ag) {
...
func TestCreateAgentSession(t *testing.T) {
	r := newTestRunner()
	ag := &mockAgent{
		card: agentschema.NewAgentCard(agentschema.WithAgentName("sess-agent"), agentschema.WithAgentDescription("会话 Agent")),
	}
...
func TestPrepareAgent_按实例有会话(t *testing.T) {
	r := newTestRunner()
	ag := &mockAgent{
		card:   agentschema.NewAgentCard(agentschema.WithAgentName("pa-inst-sess"), agentschema.WithAgentDescription("按实例有会话")),
		result: map[string]any{"output": "ok"},
	}
...
func TestPrepareAgent_按ID有会话(t *testing.T) {
	r := newTestRunner()
	ag := &mockAgent{
		card:   agentschema.NewAgentCard(agentschema.WithAgentID("registered-agent"), agentschema.WithAgentName("已注册 Agent"), agentschema.WithAgentDescription("按ID有会话")),
		result: map[string]any{"output": "ok"},
	}
...
func TestPrepareAgent_按ID无会话(t *testing.T) {
	r := newTestRunner()
	ag := &mockAgent{
		card:   agentschema.NewAgentCard(agentschema.WithAgentID("byid-no-sess"), agentschema.WithAgentName("按ID无会话"), agentschema.WithAgentDescription("按ID无会话")),
		result: map[string]any{"output": "ok"},
	}
...
func TestPrepareAgent_按实例无会话(t *testing.T) {
	r := newTestRunner()
	ag := &mockAgent{
		card:   agentschema.NewAgentCard(agentschema.WithAgentName("inst-no-sess"), agentschema.WithAgentDescription("按实例无会话")),
		result: map[string]any{"output": "ok"},
	}
...
func TestPrepareAgent_自定义会话ID(t *testing.T) {
	r := newTestRunner()
	ag := &mockAgent{
		card:   agentschema.NewAgentCard(agentschema.WithAgentName("custom-conv"), agentschema.WithAgentDescription("自定义会话ID")),
		result: map[string]any{"output": "ok"},
	}
