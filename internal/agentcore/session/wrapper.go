...
//
// Python: openjiuwen/core/session/internal/wrapper.py (RouterSession)
...
// Python: RouterSession.get_state：继承 StateSession 的读取能力
...
// Python: RouterSession.update_state: pass
func (r *RouterSessionFacade) UpdateState(data map[string]any) {
	// 路由场景禁止写入状态，静默忽略
}

// GetGlobalState 获取全局状态值（只读，允许）
// Python: RouterSession.get_global_state：继承 StateSession 的读取能力
...
// Python: RouterSession.update_global_state: pass
...
// Python: RouterSession.trace: await TracerWorkflowUtils.trace(self._inner, data)
...
// Python: RouterSession.trace_error: await TracerWorkflowUtils.trace_error(self._inner, error)
...
// Python: RouterSession.interact: pass
...
// Python: RouterSession.write_stream: pass
...
// Python: RouterSession.write_custom_stream: pass
...
// GetEnv 获取环境变量值 — 禁止操作
// Python: RouterSession.get_env: pass
...
// Python: RouterSession.get_workflow_config / get_agent_config: pass
