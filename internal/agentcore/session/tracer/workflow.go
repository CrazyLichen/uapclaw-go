...
func (TracerWorkflowUtils) TraceWorkflowStart(ctx context.Context, session BaseWorkflowSession, inputs any) error {
	if session.Tracer() == nil {
		return nil
	}
	return session.Tracer().TriggerWorkflow(ctx, TraceWFCallStart, "", &TriggerParams{
...
func (TracerWorkflowUtils) TraceComponentBegin(ctx context.Context, session BaseWorkflowSession, sourceIDs []string) error {
	...
	return session.Tracer().TriggerWorkflow(ctx, TraceWFCallStart, session.ParentID(), &TriggerParams{
...
func (TracerWorkflowUtils) TraceComponentInputs(ctx context.Context, session BaseWorkflowSession, inputs any, send bool) error {
	if session.Tracer() == nil {
		return nil
	}
	return session.Tracer().TriggerWorkflow(ctx, TraceWFPreInvoke, session.ParentID(), &TriggerParams{
		InvokeID:          session.ExecutableID(),
		Inputs:            inputs,
		NeedSend:          send,
...
func (TracerWorkflowUtils) TraceComponentStreamInput(ctx context.Context, session BaseWorkflowSession, chunk any, send bool) error {
	...
	return session.Tracer().TriggerWorkflow(ctx, TraceWFPreStream, session.ParentID(), &TriggerParams{
		InvokeID: session.ExecutableID(),
		Chunk:    chunk,
		NeedSend: send,
	})
...
func (TracerWorkflowUtils) TraceComponentOutputs(ctx context.Context, session BaseWorkflowSession, outputs any) error {
	if session.Tracer() == nil {
		return nil
	}
	return session.Tracer().TriggerWorkflow(ctx, TraceWFPostInvoke, session.ParentID(), &TriggerParams{
		InvokeID: session.ExecutableID(),
		Outputs:  outputs,
	})
}
...
func (TracerWorkflowUtils) TraceComponentStreamOutput(ctx context.Context, session BaseWorkflowSession, chunk any) error {
	...
	return session.Tracer().TriggerWorkflow(ctx, TraceWFPostStream, session.ParentID(), &TriggerParams{
		InvokeID: session.ExecutableID(),
		Chunk:    chunk,
	})
}
...
func (TracerWorkflowUtils) TraceWorkflowDone(ctx context.Context, session BaseWorkflowSession, outputs any) error {
	if session.Tracer() == nil {
		return nil
	}
	return session.Tracer().TriggerWorkflow(ctx, TraceWFCallDone, "", &TriggerParams{
		InvokeID: session.WorkflowID(),
		Outputs:  outputs,
		Metadata: getWorkflowMetadata(session),
	})
...
func (TracerWorkflowUtils) TraceComponentDone(ctx context.Context, session BaseWorkflowSession) error {
	...
	err := session.Tracer().TriggerWorkflow(ctx, TraceWFCallDone, parentID, &TriggerParams{
...
func (TracerWorkflowUtils) Trace(ctx context.Context, session BaseWorkflowSession, data map[string]any) error {
	...
	return session.Tracer().TriggerWorkflow(ctx, TraceWFInvoke, session.ParentID(), &TriggerParams{
		InvokeID:     session.ExecutableID(),
		OnInvokeData: data,
	})
}
...
func (TracerWorkflowUtils) TraceComponentInteractiveInputs(ctx context.Context, session BaseWorkflowSession, inputs any, send bool) error {
	if session.Tracer() == nil {
		return nil
	}
	return session.Tracer().TriggerWorkflow(ctx, TraceWFInteract, session.ParentID(), &TriggerParams{
		InvokeID:          session.ExecutableID(),
		Inputs:            inputs,
		NeedSend:          send,
		ComponentMetadata: getComponentMetadata(session),
