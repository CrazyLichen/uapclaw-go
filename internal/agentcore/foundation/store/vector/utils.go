...
//
// Python: vector/utils.py (convert_l2_squared)
...
// 公式: (rawScore + 1) / 2
//
// Python: vector/utils.py (convert_cosine_similarity)
...
// Chroma 使用余弦距离。
//
// Python: vector/utils.py (convert_cosine_distance)
...
// Milvus 使用内积。
//
// Python: vector/utils.py (convert_ip_similarity)
...
//
// Python: vector/utils.py (convert_ip_distance)
