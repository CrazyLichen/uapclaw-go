...
//
// Python: Union[str, List[BaseMessage], List[dict]]
...
//
// Python: openjiuwen/core/foundation/llm/model_clients/base_model_client.py
...
//
// Python: messages=[UserMessage("你好"), AssistantMessage("hi")]
...
//
// Python: messages=[{"role": "user", "content": "你好"}]
