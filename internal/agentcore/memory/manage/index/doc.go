...
// MemoryOption/MemoryOptionConfig 提供对齐 Python **kwargs 的 Functional Options 扩展机制。
...
//	index/
//	├── doc.go               # 包文档
//	├── base_manager.go      # BaseMemoryManager 接口 + memoryManagerBase 嵌入结构体 + MemoryOption 类型
