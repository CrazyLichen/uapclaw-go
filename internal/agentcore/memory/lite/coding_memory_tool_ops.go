...
func prepareAppendMode(ctx context.Context, toolCtx *CodingMemoryToolContext, resolved string, basename string, body string, fm map[string]string) *ConflictResult {
