...
// HitInfo 记忆检索命中结果。
// Python: openjiuwen/core/memory/common/base.py hits: list[Tuple[str, float]] 中的单个元素
type HitInfo struct {
	// ID 记忆标识
	ID string
	// Score 相似度分数
...
// Python: openjiuwen/core/memory/common/base.py generate_idx_name
...
// Python: openjiuwen/core/memory/common/base.py parse_memtype_from_idx_name
// 取最后一个 _ 之后的部分
...
// Python: openjiuwen/core/memory/common/base.py parse_memory_hit_infos
