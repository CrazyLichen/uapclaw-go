...
// Python: openjiuwen/core/memory/migration/operation/base_operation.py (OperationMetadata)
...
// Python: openjiuwen/core/memory/migration/operation/base_operation.py (BaseOperation)
...
type Operation interface {
	...
	Description() string
	// TypeName 返回操作类型的名称。
	// Python: self.__class__.__name__ —— Go 中由于嵌入 BaseOperation 的方法集
...
// SchemaVersion 返回操作的 schema 版本号。
// Python: BaseOperation.schema_version (property)
func (op *BaseOperation) SchemaVersion() int {
	return op.Metadata.SchemaVersion
}

// Description 返回操作的描述。
// Python: BaseOperation.description (property)
...
func (op *BaseOperation) Description() string {
	...
	// Python: return self.__class__.__name__
