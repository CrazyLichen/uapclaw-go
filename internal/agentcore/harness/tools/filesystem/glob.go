...
const (
	...
	// Python: GlobTool.DEFAULT_MAX_RESULTS (filesystem.py L1401)
...
// Python: GlobTool (filesystem.py L1400)
...
// Python: GlobTool._resolve_search_path (filesystem.py L1408-1411)
