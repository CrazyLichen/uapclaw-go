...
var (
	...
	// Python: _PAID_SEARCH_PROVIDER_KEY_ENVS (web_tools.py L93-98)
	...
	// Python: _PAID_SEARCH_PROVIDER_ORDER (web_tools.py L99)
	paidSearchProviderOrder = []string{"perplexity", "bocha", "jina", "serper"}

	// queryStopwords 查询词停用词
	// Python: _QUERY_STOPWORDS (web_tools.py L38-51)
	...
	// Python: _TIMELY_QUERY_HINTS (web_tools.py L52-70)
	...
	// Python: _LOW_CONFIDENCE_RESULT_DOMAINS (web_tools.py L71-79)
...
// Python: is_free_search_enabled() (web_tools.py L444-449)
...
// Python: is_paid_search_enabled() (web_tools.py L452-454)
...
// Python: _env_flag() (web_tools.py L436-441)
...
// Python: _configured_paid_search_providers() (web_tools.py L457-463)
...
// Python: _safe_env_choice() (web_tools.py L466-475)
...
// Python: _PAID_SEARCH_API_KEY_ENVS (web_tools.py L100)
...
// Python: _no_proxy_entries() (web_tools.py L147-149)
...
// Python: _is_debug_enabled() (web_tools.py L305-307)
func isDebugEnabled() bool {
	return envFlag(freeSearchDebugEnv, false)
}

// getDebugDir 获取调试输出目录
// Python: _get_debug_dir() (web_tools.py L310-315)
