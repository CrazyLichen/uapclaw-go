...
// Python: RESEARCH_AGENT_FACTORY_NAME
...
var (
	...
	// Python: DEFAULT_RESEARCH_AGENT_SYSTEM_PROMPT
	...
	// Python: DEFAULT_RESEARCH_AGENT_DESCRIPTION
...
// Python: build_research_agent_config(model, language=..., workspace=..., ...)
//
...
func BuildResearchAgentConfig(model *llm.Model, params *hschema.SubagentCreateParams) *hschema.SubAgentConfig {
	...
	// 非 nil 则使用用户显式指定的值
	// Python: build_research_agent_config 不传 restrict_to_work_dir，使用 SubAgentConfig 默认值
...
// Python: DEFAULT_RESEARCH_AGENT_SYSTEM_PROMPT.get(resolved_language, ...)
...
// Python: DEFAULT_RESEARCH_AGENT_DESCRIPTION.get(resolved_language, ...)
