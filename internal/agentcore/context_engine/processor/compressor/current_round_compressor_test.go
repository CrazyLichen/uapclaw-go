...
func (f *crcFakeBaseModelClient) Stream(_ context.Context, _ model_clients.MessagesParam, _ ...model_clients.StreamOption) (*model_clients.StreamResult, error) {
	return nil, nil
}
...
func TestCurrentRoundCompressor_OnAddMessages_触发压缩(t *testing.T) {
	...
	updated := mc.GetMessages(nil, true)
	found := false
