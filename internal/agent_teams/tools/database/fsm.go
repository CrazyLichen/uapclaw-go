...
// Python: is_valid_transition(current, new, MEMBER_TRANSITIONS)
...
// Python: is_valid_transition(current, target, EXECUTION_TRANSITIONS)
// 委托 fsm 包实现。
...
// Python: is_valid_transition(current, new, TASK_TRANSITIONS)
