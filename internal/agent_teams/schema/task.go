...
// Python: TaskOpResult (openjiuwen/agent_teams/schema/task.py)
...
// Python: TaskCreateResult (openjiuwen/agent_teams/schema/task.py)
...
// Python: TaskSummary (openjiuwen/agent_teams/schema/task.py)
...
// Python: TaskDetail (openjiuwen/agent_teams/schema/task.py)
...
// Python: TaskListResult (openjiuwen/agent_teams/schema/task.py)
...
// Python: NewTaskSpec (openjiuwen/agent_teams/schema/task.py)
...
// Python: GraphMutationResult (openjiuwen/agent_teams/schema/task.py)
...
// Python: TaskCreateResult.fail(reason)
...
// Python: GraphMutationResult.success(refreshed_tasks)
...
// Python: GraphMutationResult.fail(reason)
